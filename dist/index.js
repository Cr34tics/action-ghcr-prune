;(() => {
  var e = {
    ...
    6752: (e, t, A) => {
      ...
      const l = A(8707)
      const u = A(3440)
      const { InvalidArgumentError: E } = l
      const h = A(6615)
      const d = A(9136)
      const Q = A(7365)
      const C = A(7501)
    ...
    6862: (e, t, A) => {
      ...
      const c = A(3440)
      const { AsyncResource: g } = A(6698)
      const { addSignal: l, removeSignal: u } = A(158)
      const E = A(4589)
    ...
    4043: (e, t, A) => {
      ...
      class RequestHandler extends c {
        ...
        onHeaders(e, t, A, r) {
          ...
          const E = l === 'raw' ? i.parseRawHeaders(t) : i.parseHeaders(t)
          if (e < 200) {
            if (this.onInfo) {
          ...
          const h = l === 'raw' ? i.parseHeaders(t) : E
    ...
    9927: (e, t, A) => {
      ...
      const c = A(3440)
      const { ReadableStreamFrom: g } = A(3440)
      ...
      function isLocked(e) {
        return (e[E] && e[E].locked === true) || e[l]
      }
    ...
    9136: (e, t, A) => {
      ...
      function buildConnector({
        ...
        return function connect(
          ...
          const p = l(new WeakRef(I), { timeout: a, hostname: t, port: g })
          I.setNoDelay(true)
    ...
    8707: (e) => {
      ...
      const l = Symbol.for('undici.error.UND_ERR_INFO')
    ...
    637: (e, t, A) => {
      ...
      class Parser {
        ...
        onHeadersComplete(e, t, A) {
          ...
          const g = c.onHeaders(e, i, this.resume, a) === false
          if (c.aborted) {
            return -1
          }
          if (c.method === 'HEAD') {
        ...
        onMessageComplete() {
          ...
          if (l.method !== 'HEAD' && i && c !== parseInt(i, 10)) {
            s.destroy(t, new a())
            return -1
          }
          l.onComplete(n)
      ...
      function resumeH1(e) {
        ...
        if (t && !t.destroyed) {
          ...
          if (e[y] === 0) {
            if (t[p].timeoutType !== ge) {
              t[p].setTimeout(e[G], ge)
            }
      ...
      function writeStream(e, t, A, o, n, i, a, g) {
    ...
    8788: (e, t, A) => {
      ...
      function writeStream(e, t, A, n, i, a, c, g) {
        r(g !== 0 || a[E] === 0, 'stream body cannot be pipelined')
        const u = s(i, n, (r) => {
          if (r) {
            o.destroy(u, r)
            e(r)
      ...
      function _resume(e, t) {
        while (true) {
          ...
          if (e[h].protocol === 'https:' && e[d] !== A.servername) {
            ...
            e[d] = A.servername
            e[K]?.destroy(new l('servername changed'), () => {
              e[K] = null
              resume(e)
            })
          }
    ...
    628: (e, t, A) => {
      ...
      const g = A(3440)
      const { kUrl: l, kInterceptors: u } = A(6443)
      const E = A(9136)
        ...
        constructor(
          ...
          this[u] =
            p.interceptors?.Pool && Array.isArray(p.interceptors.Pool)
              ...
              : []
          this[d] = t || null
          this[l] = g.parseOrigin(e)
          this[h] = { ...g.deepClone(p), connect: r, allowH2: I }
    ...
    6672: (e, t, A) => {
      ...
      class Http1ProxyWrapper extends l {
        #g
        constructor(e, { headers: t = {}, connect: A, factory: r }) {
          ...
          this[I] = t
          if (r) {
            this.#g = r(e, { connect: A })
          } else {
            this.#g = new Q(e, { connect: A })
          }
        }
        [n](e, t) {
          const A = t.onHeaders
        ...
        async [o](e) {
          return this.#g.destroy(e)
        }
      }
      class ProxyAgent extends l {
        constructor(e) {
          super()
    ...
    7816: (e, t, A) => {
      ...
      class RetryHandler {
        ...
        static [s](e, { state: t, opts: A }, r) {
          ...
          const B = C > 0 ? Math.min(C, l) : Math.min(g * u ** (Q - 1), l)
          setTimeout(() => r(null), B)
        }
        onHeaders(e, t, A, s) {
          const n = i(t)
          ...
          if (this.end == null) {
            if (e === 206) {
              ...
              const { start: i, size: c, end: g = c - 1 } = o
              r(i != null && Number.isFinite(i), 'content-range mismatch')
              r(g != null && Number.isFinite(g), 'invalid content-length')
              this.start = i
              this.end = g
            }
            if (this.end == null) {
    ...
    2824: (e, t, A) => {
      ...
      })((g = t.HEADER_STATE || (t.HEADER_STATE = {})))
      t.SPECIAL_HEADERS = {
    ...
    7365: (e, t, A) => {
      ...
      class MockClient extends s {
        ...
        async [a]() {
          await r(this[c])()
          this[u] = 0
          this[i][h.kClients].delete(this[g])
        }
      }
    ...
    3397: (e, t, A) => {
      ...
      function mockDispatch(e, t) {
        ...
        function handleReply(r, s = n) {
          ...
          if (l(g)) {
            g.then((e) => handleReply(r, e))
            return
          }
          const u = getResponseData(g)
      ...
      function onTick() {
        ...
        while (e < A) {
          ...
          if (s._state === c) {
            s._idleStart = t - r
            s._state = g
          } else if (s._state === g && t >= s._idleStart + s._idleTimeout) {
            s._state = a
            s._idleStart = -1
    ...
    9634: (e, t, A) => {
      ...
      const { Response: c, cloneResponse: g, fromInnerResponse: l } = A(9051)
      ...
      class Cache {
        ...
        async addAll(e) {
          ...
          let g = 0
          for (const e of i) {
            const t = { type: 'put', request: r[g], response: e }
            c.push(t)
            g++
          }
          const l = C()
    ...
    1238: (e, t, A) => {
      ...
      const { isNetworkError: g } = A(9051)
      const { delay: l } = A(4811)
      ...
      class EventSource extends EventTarget {
        ...
        async #P() {
          ...
          this.#H = Q
          this.dispatchEvent(new Event('error'))
          await l(this.#p.reconnectionTime)
          if (this.#H !== Q) return
    ...
    4492: (e, t, A) => {
      ...
      function extractBody(e, t = false) {
        ...
        const u = { stream: A, source: c, length: g }
        return [u, l]
      }
    ...
    4495: (e) => {
      ...
      const l = ['GET', 'HEAD', 'OPTIONS', 'TRACE']
      const u = new Set(l)
    ...
    116: (e, t, A) => {
      ...
      function multipartFormDataParser(e, t) {
        g(t !== 'failure' && t.essence === 'multipart/form-data')
        ...
        while (true) {
          ...
          let { name: A, filename: l, contentType: E, encoding: h } = t
          i.position += 2
          let C
          {
      ...
      function makeEntry(e, t, A) {
        if (typeof t === 'string') {
          ...
          if (A !== undefined) {
            ...
            t = t instanceof g ? new u([t], A, e) : new i(t, A, e)
          }
        }
    ...
    660: (e, t, A) => {
      ...
      class HeadersList {
        ...
        contains(e, t) {
          return this[l].has(t ? e : e.toLowerCase())
        }
        clear() {
          this[l].clear()
          this[u] = null
        ...
        append(e, t, A) {
          ...
          const s = this[l].get(r)
          if (s) {
            const e = r === 'cookie' ? '; ' : ', '
            this[l].set(r, { name: s.name, value: `${s.value}${e}${t}` })
          } else {
            this[l].set(r, { name: e, value: t })
          }
          if (r === 'set-cookie') {
            ;(this.cookies ??= []).push(t)
          }
        ...
        get(e, t) {
          return this[l].get(t ? e : e.toLowerCase())?.value ?? null
        }
        *[Symbol.iterator]() {
          for (const {
            0: e,
        ...
        get entries() {
          const e = {}
          if (this[l].size !== 0) {
            for (const { name: t, value: A } of this[l].values()) {
              e[t] = A
            }
          }
          return e
        ...
        toSortedArray() {
          ...
          if (e <= 32) {
            ...
            const A = this[l][Symbol.iterator]()
            const r = A.next().value
            t[0] = [r[0], r[1].value]
            c(r[1].value !== null)
            for (let r = 1, s = 0, o = 0, n = 0, i = 0, a, g; r < e; ++r) {
              g = A.next().value
              a = t[r] = [g[0], g[1].value]
              c(a[1] !== null)
              n = 0
      ...
      class Headers {
        ...
        [g.inspect.custom](e, t) {
          t.depth ??= e
          return `Headers ${g.formatWithOptions(t, this.#x.entries)}`
        }
    ...
    4398: (e, t, A) => {
      ...
      const { Request: c, cloneRequest: g } = A(9967)
      const l = A(8522)
      const {
        bytesMatch: u,
      ...
      const {
        dataURLProcessor: ce,
        serializeAMimeType: ge,
        minimizeSupportedMimeType: le,
      } = A(1900)
      ...
      function fetch(e, t = undefined) {
        ...
        const processResponse = (e) => {
          ...
          if (e.aborted) {
            abortFetch(A, s, n, g.serializedAbortReason)
            return
          }
          if (e.type === 'error') {
    ...
    9967: (e, t, A) => {
      ...
      class Request {
        constructor(e, t = {}) {
          ...
          let s = null
          let o = null
          const l = I.settingsObject.baseUrl
          let h = null
          if (typeof e === 'string') {
            this[M] = t.dispatcher
            let A
        ...
        clone() {
          ...
          return fromInnerRequest(e, t.signal, l(this[S]))
        }
      ...
      i.dictionaryConverter = function (e) {
        return (t, A, r) => {
          ...
          for (const s of e) {
            ...
            if (a || l || g !== undefined) {
              g = c(g, A, `${r}.${e}`)
              if (s.allowedValues && !s.allowedValues.includes(g)) {
                throw i.errors.exception({
                  header: A,
    ...
    8355: (e, t, A) => {
      ...
      class FileReader extends EventTarget {
        ...
        readAsArrayBuffer(e) {
          ...
          l.argumentLengthCheck(arguments, 1, 'FileReader.readAsArrayBuffer')
          e = l.converters.Blob(e, { strict: false })
          s(this, e, 'ArrayBuffer')
        }
        readAsBinaryString(e) {
          l.brandCheck(this, FileReader)
          l.argumentLengthCheck(arguments, 1, 'FileReader.readAsBinaryString')
          e = l.converters.Blob(e, { strict: false })
          s(this, e, 'BinaryString')
        }
        readAsText(e, t = undefined) {
          l.brandCheck(this, FileReader)
          l.argumentLengthCheck(arguments, 1, 'FileReader.readAsText')
          e = l.converters.Blob(e, { strict: false })
          if (t !== undefined) {
            t = l.converters.DOMString(t, 'FileReader.readAsText', 'encoding')
          }
          s(this, e, 'Text', t)
        }
        readAsDataURL(e) {
          l.brandCheck(this, FileReader)
          l.argumentLengthCheck(arguments, 1, 'FileReader.readAsDataURL')
          e = l.converters.Blob(e, { strict: false })
          s(this, e, 'DataURL')
        }
        abort() {
    ...
    3610: (e, t, A) => {
      ...
      const { serializeAMimeType: g, parseMIMEType: l } = A(1900)
            ...
            try {
              ...
              if (!c && u.isUint8Array(d)) {
                ...
                queueMicrotask(() => {
                  e[r] = 'done'
                  try {
                    const r = packageData(l, A, t.type, a)
                    if (e[n]) {
                      return
                    }
                    e[o] = r
    ...
    6897: (e, t, A) => {
      ...
      function establishWebSocketConnection(e, t, A, s, o, n) {
        ...
        const g = 'permessage-deflate; client_max_window_bits'
        a.headersList.append('sec-websocket-extensions', g)
        const l = m({
          request: a,
      ...
      function closeWebSocketConnection(e, t, A, r) {
        if (d(e) || Q(e)) {
          ...
          if (t !== undefined && A === undefined) {
            ...
            g.frameData.writeUInt16BE(t, 0)
          } else if (t !== undefined && A !== undefined) {
            g.frameData = Buffer.allocUnsafe(2 + r)
            g.frameData.writeUInt16BE(t, 0)
            g.frameData.write(A, 2, 'utf-8')
          } else {
            g.frameData = n
          }
          const l = e[u].socket
          l.write(g.createFrame(i.CLOSE))
          e[c] = o.SENT
          e[a] = s.CLOSING
        } else {
          e[a] = s.CLOSING
    ...
    8625: (e, t, A) => {
      ...
      const { ErrorEvent: g, createFastMessageEvent: l } = A(5188)
      ...
      function websocketMessageReceived(e, t, A) {
        ...
        fireEvent('message', e, l, { origin: e[i].origin, data: s })
      }
      ...
      function failWebsocketConnection(e, t) {
        ...
        if (t) {
          fireEvent('error', e, (e, t) => new g(e, t), {
            error: new Error(t),
            message: t,
          })
        }
    ...
    3726: (e, t, A) => {
      ...
      class WebSocket extends EventTarget {
        ...
        constructor(e, t = []) {
          ...
          this[u] = m(i, t, c, this, (e, t) => this.#ge(e, t), s)
  ...
  ;(() => {
    ...
    const h = [g.BadGateway, g.ServiceUnavailable, g.GatewayTimeout]
    ...
    class lib_HttpClient {
      ...
      getJson(e) {
        return c(this, arguments, void 0, function* (e, t = {}) {
          t[l.Accept] = this._getExistingOrDefaultHeader(
            t,
            l.Accept,
            u.ApplicationJson,
          )
      ...
      postJson(e, t) {
        return c(this, arguments, void 0, function* (e, t, A = {}) {
          const r = JSON.stringify(t, null, 2)
          A[l.Accept] = this._getExistingOrDefaultHeader(
            A,
            l.Accept,
            u.ApplicationJson,
          )
          A[l.ContentType] = this._getExistingOrDefaultContentTypeHeader(
            A,
            u.ApplicationJson,
          )
          const s = yield this.post(e, r, A)
      ...
      _getExistingOrDefaultContentTypeHeader(e, t) {
        let A
        if (this.requestOptions && this.requestOptions.headers) {
          const e = lowercaseKeys(this.requestOptions.headers)[l.ContentType]
          if (e) {
            if (typeof e === 'number') {
              A = String(e)
            } else if (Array.isArray(e)) {
    ...
    function getExecOutput(e, t, A) {
      return $(this, void 0, void 0, function* () {
        ...
        const u = yield exec_exec(
          e,
          t,
          Object.assign(Object.assign({}, A), { listeners: l }),
        )
        o += i.end()
        n += a.end()
    ...
    const ge = Function.bind
    const le = ge.bind(ge)
    function bindApi(e, t, A) {
      const r = le(removeHook, null).apply(null, A ? [t, A] : [t])
      e.api = { remove: r }
      e.remove = r
      ;['before', 'error', 'after', 'wrap'].forEach((r) => {
        const s = A ? [t, r, A] : [t, r]
        e[r] = e.api[r] = le(addHook, null).apply(null, s)
      })
    }
    function Singular() {
    ...
    async function fetchWrapper(e) {
      ...
      const g = { url: a, status: i, headers: c, data: '' }
      if ('deprecation' in c) {
      ...
      if (e.method === 'HEAD') {
        ...
        throw new RequestError(n.statusText, i, { response: g, request: e })
      }
      if (i === 304) {
        g.data = await getResponseData(n)
        throw new RequestError('Not modified', i, { response: g, request: e })
      }
      if (i >= 400) {
        g.data = await getResponseData(n)
        throw new RequestError(toErrorMessage(g.data), i, {
          response: g,
          request: e,
        })
      }
      g.data = r ? await getResponseData(n) : n.body
      return g
    }
    ...
    const run = async () => {
      try {
        ...
        const g = getOctokit(e)
        let l
        let u
        let E
        if (A) {
          l = listUserContainerVersions(g)(A, r)
          u = o ? dryRunDelete : deleteUserContainerVersion(g)(A, r)
          E = A
        } else if (t) {
          l = listOrgContainerVersions(g)(t, r)
          u = o ? dryRunDelete : deleteOrgContainerVersion(g)(t, r)
          E = t
        } else {
          l = listAuthenticatedUserContainerVersions(g)(r)
          u = o ? dryRunDelete : deleteAuthenticatedUserContainerVersion(g)(r)
        }
        const h = versionFilter(c)
        const d = await getPruningList(l, h)(n)
        if (s) {
          const t = createDockerAPIClient()
          const A = dockerAPIGet(t, e, E ?? '', r)
          const s = getManifest(A)
          const o = await getMultiPlatPruningList(l, s)(d)
          if (o) {
            d.push(...o)
          }
        } else if (a) {
        ...
        info(`Found a total of ${String(d.length)} versions to prune`)
        const Q = await prune(u)(d)
        await writeSummary(r, o, d, Q)
        if (Q.length !== d.length) {
          setFailed(
            `Failed to prune some versions: ${String(Q.length)} out of ${String(d.length)} versions were pruned`,
          )
        }
